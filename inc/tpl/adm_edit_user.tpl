<div class="marg default-gray edit_user">
   <h2>Editing <b><a href="user/%user_username%" target="_blank">%user_username%</a></b> <a class="btn" target="_blank" style="vertical-align:top; margin-left:10px;" href="uploads_by/%user_username%">View Mods &raquo;</a></h2>
   <div class="wbox">
      <form>
